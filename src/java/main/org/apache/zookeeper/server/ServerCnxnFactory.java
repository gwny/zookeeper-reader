...
public abstract class ServerCnxnFactory {
	...
	static public ServerCnxnFactory createFactory() throws IOException {
		String serverCnxnFactoryName = System.getProperty(ZOOKEEPER_SERVER_CNXN_FACTORY); // tianyakee:netty或者nio
	...
	protected void configureSaslLogin() throws IOException {
		...
		try {
			...
			// handle below: might be harmless if the user doesn't intend to use JAAS
			// authentication.
			securityException = e;
		}
		...
		// the user has required sasl by specifying a LOGIN_CONTEXT_NAME_KEY or a jaas
		// file
